...
public class ReservaService
{
    ...
    public async Task<ResponseService<List<Reserva>>> GetReservas()
    {
        ...
        catch (Exception ex)
        {
            ...
            return new ResponseService<List<Reserva>>(new(), "Error al cargar reservas", false);
        }
    }
    ...
    public async Task<ResponseService<List<Reserva>>> GetReservas(string? usuarioId = null, string? espacioId = null)
    {
        ...
        {
            Console.WriteLine($"Error al filtrar reservas: {ex.Message}");
            return new ResponseService<List<Reserva>>(new(), "Error al filtrar reservas", false);
        }
    }
    ...
    public async Task<ResponseService<Reserva>> CreateReserva(Reserva reserva)
    {
        ...
        catch (Exception ex)
        {
            ...
            return new ResponseService<Reserva>(null, "Error al crear reserva", false);
        }
    }
    ...
    public async Task<ResponseService<Reserva>> CancelarReserva(int id)
    {
        ...
        catch (Exception ex)
        {
            ...
            return new ResponseService<Reserva>(null, "Error al cancelar reserva", false);
        }
    }
    ...
    public async Task<ResponseService<Reserva>> FinalizarReserva(int id)
    {
        ...
        catch (Exception ex)
        {
            ...
            return new ResponseService<Reserva>(null, "Error al finalizar reserva", false);
        }
    }
}