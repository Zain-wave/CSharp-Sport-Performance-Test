...
public class UsuarioService
{
    ...
    public async Task<ResponseService<List<Usuario>>> GetUsuarios()
    {
        ...
        return new ResponseService<List<Usuario>>(
            usuarios,
            usuarios.Count > 0 ? "Usuarios cargados" : "No hay usuarios",
            usuarios.Count > 0);
    }

    public async Task<ResponseService<Usuario>> GetUsuario(int id)
    {
        ...
        return new ResponseService<Usuario>(usuario, "Usuario encontrado", true);
    }
